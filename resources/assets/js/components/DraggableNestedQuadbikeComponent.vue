...
<!--                                </div>-->
                                ...
                                <div class="company_div">
                                  <button title="Редактировать" class="btn-primary fa fa-pen-square btn-border" @click="showEditOrderModal(el1.id)">
                                    ...
                                    <span class="company_span" v-text="getShortName(el1.company)"></span>
                                    <span class="comment_span" :title="el1.company.name" v-text="getAddress(el1.company.name, 15)"></span>
                                </div>
                            </div>
                        </draggable>
                    </div>
...
<script>
    ...
    import modalDispatcherRequest from './modals/modal-edit';
