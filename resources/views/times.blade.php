<form id="order-form" method="POST" action="{{ route('route.times.set') }}">
    @csrf
    <div class="row">
        <div class="col-lg-12">
            <div class="row">
                    ...
                    <div class="form-item">
                        <div id="checkbox-container-monday" class="checkbox-container">
                            @foreach($times as $time)
                                <div class="d-flex">
                                    <div class="col-6 p-0">
                                        <input type="hidden" name="times[monday][{{ $time->id }}]" value="{{ $time->id }}" disabled> {{ $time->name }}
                                    </div>
                    ...
                    <div class="form-item">
                        <div id="checkbox-container-tuesday" class="checkbox-container">
                            @foreach($times as $time)
                                <div class="d-flex">
                                    <div class="col-6 p-0">
                                        <input type="hidden" name="times[tuesday][{{ $time->id }}]" value="{{ $time->id }}" disabled> {{ $time->name }}
                                    </div>
                                    <div class="col-6 pl-0">
                    ...
                    <div class="form-item">
                        <div id="checkbox-container-wednesday" class="checkbox-container">
                            @foreach($times as $time)
                                <div class="d-flex">
                                    <div class="col-6 p-0">
                                        <input type="hidden" name="times[wednesday][{{ $time->id }}]" value="{{ $time->id }}" disabled> {{ $time->name }}
                                    </div>
                                    <div class="col-6 pl-0">
                    ...
                    <div class="form-item">
                        <div id="checkbox-container-thursday" class="checkbox-container">
                            @foreach($times as $time)
                                <div class="d-flex">
                                    <div class="col-6 p-0">
                                        <input type="hidden" name="times[thursday][{{ $time->id }}]" value="{{ $time->id }}" disabled> {{ $time->name }}
                                    </div>
                                    <div class="col-6 pl-0">
                    ...
                    <div class="form-item">
                        <div id="checkbox-container-friday" class="checkbox-container">
                            @foreach($times as $time)
                                <div class="d-flex">
                                    <div class="col-6 p-0">
                                        <input type="hidden" name="times[friday][{{ $time->id }}]" value="{{ $time->id }}" disabled> {{ $time->name }}
                                    </div>
                                    <div class="col-6 pl-0">
                    ...
                    <div class="form-item">
                        <div id="checkbox-container-saturday" class="checkbox-container">
                            @foreach($times as $time)
                                <div class="d-flex">
                                    <div class="col-6 p-0">
                                        <input type="hidden" name="times[saturday][{{ $time->id }}]" value="{{ $time->id }}" disabled> {{ $time->name }}
                                    </div>
                                    <div class="col-6 pl-0">
                    ...
                    <div class="form-item">
                        <div id="checkbox-container-sunday" class="checkbox-container">
                            @foreach($times as $time)
                                <div class="d-flex">
                                    <div class="col-6 p-0">
                                        <input type="hidden" name="times[sunday][{{ $time->id }}]" value="{{ $time->id }}" disabled> {{ $time->name }}
                                    </div>
                                    <div class="col-6 pl-0">
    ...
    $(document).ready(function() {
        ...
        $('#route').click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $('input[name*="times"]').prop('disabled', true);
                            ...
                            jQuery.each(response[0].days, function (index, item) {
                                if( item.weekday !== '' && item.times.length > 0){
                                    ...
                                    jQuery.each(item.times, function (iIndex, iItem) {
                                        $('input[name="times['+item.weekday+']['+iItem.id+']"]').prop('disabled', false);
